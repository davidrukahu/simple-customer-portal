                            ...
                            <form method="POST" action="{{ route('admin.domains.store') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('fqdn') is-invalid @enderror" 
                                                   name="fqdn" id="fqdn" value="{{ old('fqdn') }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('registrar') is-invalid @enderror" 
                                                   name="registrar" id="registrar" value="{{ old('registrar') }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" 
                                                ...
                                                <option value="grace" {{ old('status') == 'grace' ? 'selected' : '' }}>Grace Period</option>
                                                <option value="redemption" {{ old('status') == 'redemption' ? 'selected' : '' }}>Redemption</option>
                                                <option value="transfer-pending" {{ old('status') == 'transfer-pending' ? 'selected' : '' }}>Transfer Pending</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('registered_at') is-invalid @enderror" 
                                                   name="registered_at" id="registered_at" value="{{ old('registered_at') }}" required>
                                            @error('registered_at')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('expires_at') is-invalid @enderror" 
                                                   name="expires_at" id="expires_at" value="{{ old('expires_at') }}" required>
                                            @error('expires_at')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('term_years') is-invalid @enderror" 
                                                   name="term_years" id="term_years" value="{{ old('term_years') }}" 
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mt-4">
                                                <input class="form-check-input" type="checkbox" name="auto_renew" 
                                                       id="auto_renew" value="1" {{ old('auto_renew') ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('service_notes') is-invalid @enderror" 
                                              ...
                                              placeholder="Additional notes about this domain...">{{ old('service_notes') }}</textarea>
                                    @error('service_notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('admin.domains.index') }}" class="btn btn-secondary me-2">Cancel</a>
