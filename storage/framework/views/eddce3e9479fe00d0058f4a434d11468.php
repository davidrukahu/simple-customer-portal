...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="<?php echo e(route('customer.dashboard')); ?>" class="sidebar-brand">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.domains.index')); ?>" class="nav-link <?php echo e(request()->routeIs('customer.domains.*') ? 'active' : ''); ?>">
                        <i class="bi bi-globe"></i>
                        Domains
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.services.index')); ?>" class="nav-link <?php echo e(request()->routeIs('customer.services.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH /Users/david/Desktop/onechamber-webadmin/resources/views/layouts/customer.blade.php ENDPATH**/ ?>