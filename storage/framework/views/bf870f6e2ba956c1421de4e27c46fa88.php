<?php $__env->startSection('title', 'Add New Domain'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                   name="fqdn" id="fqdn" value="<?php echo e(old('fqdn')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   name="registrar" id="registrar" value="<?php echo e(old('registrar')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <option value="grace" <?php echo e(old('status') == 'grace' ? 'selected' : ''); ?>>Grace Period</option>
                                                <option value="redemption" <?php echo e(old('status') == 'redemption' ? 'selected' : ''); ?>>Redemption</option>
                                                <option value="transfer-pending" <?php echo e(old('status') == 'transfer-pending' ? 'selected' : ''); ?>>Transfer Pending</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                                   name="registered_at" id="registered_at" value="<?php echo e(old('registered_at')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                                   name="expires_at" id="expires_at" value="<?php echo e(old('expires_at')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                                   name="term_years" id="term_years" value="<?php echo e(old('term_years')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <option value="KES" <?php echo e(old('currency') == 'KES' ? 'selected' : ''); ?>>KES</option>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mt-4">
                                                <input class="form-check-input" type="checkbox" name="auto_renew" 
                                                       id="auto_renew" value="1" <?php echo e(old('auto_renew') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              placeholder="Additional notes about this domain..."><?php echo e(old('service_notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="<?php echo e(route('admin.domains.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/david/Desktop/onechamber-webadmin/resources/views/admin/domains/create.blade.php ENDPATH**/ ?>