...
<body>
    <div class="header">
        ...
        <div class="invoice-info">
            <h2>INVOICE</h2>
            <p><strong>Invoice #:</strong> <?php echo e($invoice->number); ?></p>
            <p><strong>Issue Date:</strong> <?php echo e($invoice->issue_date->format('M d, Y')); ?></p>
    ...
    <div class="customer-info">
        ...
        <?php if($invoice->customer->billing_address_json): ?>
            ...
            <?php if($address && is_array($address)): ?>
                <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($line): ?>
                        <p><?php echo e($line); ?></p>
                    <?php endif; ?>
        ...
        <tbody>
            <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-right"><?php echo e($invoice->currency); ?> <?php echo e(number_format($item->line_total, 2)); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
        <tfoot>
            <tr>
                ...
                <td class="text-right"><strong><?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->subtotal, 2)); ?></strong></td>
            </tr>
            <?php if($invoice->tax_total > 0): ?>
                <tr>
                    <td colspan="3" class="text-right"><strong>Tax:</strong></td>
                    <td class="text-right"><strong><?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->tax_total, 2)); ?></strong></td>
                </tr>
            <?php endif; ?>
            <tr class="total-row">
                <td colspan="3" class="text-right"><strong>Total:</strong></td>
                <td class="text-right"><strong><?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->total, 2)); ?></strong></td>
            </tr>
        </tfoot>
    </table>
...
<?php /**PATH /Users/david/Desktop/onechamber-webadmin/resources/views/pdf/invoice.blade.php ENDPATH**/ ?>